...
public class Shape_2dimension extends Shape_Generator {
	
	Scaleit_button rc = new Scaleit_button("Rotate ClockWise");
	Scaleit_button rac = new Scaleit_button("Rotate Anti-ClockWise");
	Scaleit_button change = new Scaleit_button("Change Color");
